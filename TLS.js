...
if (headerbuilders !== undefined){
    ...
    console.log(`[Broadcast] SUCCES: Attack has sent succesfully`);
    console.log(`[Broadcast] URL:${process.argv[3]}`);
    console.log(`[Broadcast] Method:${process.argv[2]}`);
    console.log(`[Broadcast] Time:${process.argv[4]}`);
    console.log(`[Broadcast] Thread:${process.argv[6]}/${process.argv[5]}`);
